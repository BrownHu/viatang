...
<title>关于客服联系方式-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">关于客服联系方式</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <p>
	<span style="font-size:14px;">您可通过以下任一方式联系我们：</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">1.邮件: service@viatang.com</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">2.电话：</span><span style="font-size:14px;">86-21-64768060</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">3.在线客服:&nbsp; 点击网站右侧“在线客服”即可发起对话</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">4.站内咨询: 进入“我的唯唐“-”我的咨询”-“提交咨询”</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">5.微信: 添加微信viatangdaigou即可</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">6.QQ:&nbsp; 2042516411</span>
</p>
<p>
	<br />
</p>
<p>
	<span style="font-size:14px;">无论您在使用过程中遇到任何问题，都欢迎随时与我们联系，为您解答一切疑问！</span>
</p>        </div>
