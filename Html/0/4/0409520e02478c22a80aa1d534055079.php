...
<title>不能登录viatang 系统的常见问题-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">不能登录viatang 系统的常见问题</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <p>
	<span style="font-size:14px;">近期有部份客户反映无法登录viatang 系统， 经过排查可能是浏览器禁用了javasript脚本，相应的解决步骤如下：</span>
</p>
<h4>
	<span style="font-size:14px;">Firefox</span>
</h4>
<p>
	<span style="font-size:14px;">在菜单栏中选择“工具”–&gt;“选项”–&gt;“内容”中可见到“启用JavaScript”的选项。</span>
</p>
<p>
	<img alt="" src="http://img.ulowi.cc/ff1.png" height="499" width="511" border="0" /> 
</p>
<h4>
	<span style="font-size:14px;">Internet Explorer(IE)</span>
</h4>
<p>
	<span style="font-size:14px;">最不好找，菜单栏中“工具”中选择“Internet选项”–&gt;“安全”选项卡–&gt;选择“Internet”（蓝色的小地球）–&gt;“自定义级别”–&gt;找到“脚本”下的“</span><strong><span style="font-size:14px;">Java小程序脚本</span></strong><span style="font-size:14px;">”和“</span><strong><span style="font-size:14px;">活动脚本</span></strong><span style="font-size:14px;">”中进行启用和禁用。</span>
</p>
<p>
	<img alt="" src="http://img.ulowi.cc/ie1.png" height="512" width="512" border="0" /> 
</p>
<h4>
	<span style="font-size:14px;">Opera</span>
</h4>
<p>
	<span style="font-size:14px;">在菜单栏中选择“工具”–&gt;“首选项”–&gt;“高级”选项卡–&gt;“内容”中的“允许使用JavaScript”可以设置。</span>
</p>
<p>
	<img alt="" src="http://img.ulowi.cc/op.png" height="512" width="512" border="0" /> 
</p>
<h4>
	<span style="font-size:14px;">Safari</span>
</h4>
<p>
	<span style="font-size:14px;">在“Preferences”–&gt;“Security”选项卡中的“Enable JavaScript”，勾选上则是打开，反之是禁用。</span>
</p>
<p>
	<img alt="" src="http://img.ulowi.cc/sf.png" height="512" width="512" border="0" /> 
</p>
<h4>
	<span style="font-size:14px;">Google Chrome</span>
</h4>
<p>
	<span style="font-size:14px;">目前Google Chrome还不支持在GUI里进行Javascript的开启和禁用，而是要通过在快捷方式中添加参数的方法。</span>
</p>
<p>
	<span style="font-size:14px;">要禁用Javascript需要在Chrome的快捷方式的“属性”–&gt;“快捷方式”选项卡–&gt;“目标”中最后加入“ -disable-javascript”。</span>
</p>
<p>
	<img alt="" src="http://img.ulowi.cc/ch.png" height="472" width="367" border="0" /> 
</p>
<p>
	<span style="font-size:14px;">另外还有其它一些参数:</span>
</p>
<p>
	<span style="font-size:14px;">-disable-images&nbsp;&nbsp; 禁用图片 </span><br />
<span style="font-size:14px;"> -disable-java&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 禁用Java（非Javascript） </span><br />
<span style="font-size:14px;"> -disable-plugins&nbsp;&nbsp;&nbsp;&nbsp; 禁用插件 </span><br />
<span style="font-size:14px;"> -disable-popup-blocking&nbsp;&nbsp;&nbsp; 禁用防弹窗功能 </span><br />
<span style="font-size:14px;"> -start-maximized&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 启动时最大化</span>
</p>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/175.html">外币如何支付？</a></li><li><a href="/Help/detail/id/173.html">身在海外，怎样购买中国商品？</a></li><li><a href="/Help/detail/id/146.html">代购安全保障</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
