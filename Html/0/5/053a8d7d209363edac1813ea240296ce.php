...
<title>卖家跟我说有货，为什么订单却显示无货呢？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">卖家跟我说有货，为什么订单却显示无货呢？</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <span class="Apple-style-span" style="font-family:Arial, Helvetica, sans-serif;line-height:23px;font-size:12px;"><br />
<span style="font-size:14px;">通常，在收到您的订单后，采购人员会联系卖家并询问对方，了解商品实际库存情况。</span><br />
<span style="font-size:14px;">绝大多少情况下卖家都会很快给与答复。有少数卖家可能会晚一些，此时，您的订单状态会持续一段时间为“处理中”。</span><br />
<span style="font-size:14px;">别担心，我们会每隔一段时间与对方联系一次，若一直没有回应，为避免您的时间，我们会更改订单状态为”无货“，并备注原因。<br />
<br />
若您事先已经与卖家确认有货，也可以在提交订单时备注”拍下即可，已联系过卖家“字样，以便为您及时订购。<br />
<br />
<br />
</span></span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/62.html">手机/笔记本/化妆品可以买吗？</a></li><li><a href="/Help/detail/id/231.html">可以代购吃的吗？海关会扣吗？</a></li><li><a href="/Help/detail/id/60.html">如何挑选商品</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
