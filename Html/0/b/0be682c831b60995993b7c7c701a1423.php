...
<title>什么是国际包裹的体积重量？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">什么是国际包裹的体积重量？</p>
...
关于体积重量说明</strong><br />
<br />
您好，体积重量是一种反映快递包裹密度的计重方式；<br />
<br />
国际快递公司，通常是计算出体积重量后，跟快件的实际重量比较，取重量数值大的，用来作为实际包裹的重量来计算收取运费。<br />
<br />
绝大多数航空快递方式都是需要计算体积重量的：<br />
<br />
比如DHL与Viatang专线，体积重量计算方式是 ： 长*宽*高(cm)/5000 <br />
<br />
另外，EMS，Air，Sal目前只根据实际重量收费，特别适合体积大，实际重量较轻的商品，如大件羽绒服，棉被，洋娃娃等抛货。<br />
&nbsp;<br />
您也可以在提交代购前联系客服人员，Viatang会为您预估大概的重量，以便您对代购预算有了解。<br />        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/238.html">关于海关及税款</a></li><li><a href="/Help/detail/id/226.html">什么叫包裹的首重和续重？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
