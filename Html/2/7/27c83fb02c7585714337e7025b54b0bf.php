  ...
  <div style="width:988px; height:100%; overflow:hidden; margin:0px;" class="nobd">
    <div id="m1l" style="width:976px; height:100%; overflow:hidden; padding-bottom:20px;" class="middle bbrd">
      ...
      <div class="news_left middle" style="text-align:left;width:960px;">
        <div align="center">
          <h2><span style="font-size:14px; font-family:Arial, Helvetica, sans-serif">2015年十一国庆节放假通知</span></h2>
        </div>
        <div class="news_content1 middle" style="width:950px;font-size:14px; line-height:30px;">
          <span style="font-size:14px;">亲爱的Viatang用户：</span><br />
<br />
<span style="font-size:14px;">感谢您一直以来对Viatang的信任与支持！</span><br />
<span style="font-size:14px;">十一国庆长假即将到来，在此，我们将对服务时间进行以下调整（均为北京时间）：</span><br />
<br />
<strong><span style="font-size:14px;">1、10月1日-10月4日&nbsp;&nbsp; 全员放假 </span></strong><br />
<strong><span style="font-size:14px;">2、10月5日恢复正常营运</span></strong><br />
<br />
<span style="font-size:14px;">在此期间，Viatang仍将安排工作人员轮流值班，以确保订/运单、客服咨询、收/发货的正常处理。</span><br />
<span style="font-size:14px;">您也可以正常访问网站、提交订单及运单、咨询客服等。</span><br />
<br />
<p>
	<span style="font-size:14px;">根据我们以往的经验，国内各邮局，</span><span style="font-size:14px;">物流公司及商家均会在此期间安排休假，可能商品的到货会受影响；</span><br />
<span style="font-size:14px;">同时，包裹运单的配送也将延后至节后发送。</span><br />
<br />
<span style="font-size:14px;">给您带来的不便，敬请谅解。</span><br />
<span style="font-size:14px;">Viatang真诚为您提供更满意的服务，您的海外生活，我们一直都在！</span> 
</p>
<p>
	<br />
</p>
