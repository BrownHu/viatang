...
<title>大宗商品的运费-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">大宗商品的运费</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <span class="Apple-style-span" style="font-family:Verdana,Arial,Helvetica,sans-serif;line-height:24px;color:#666666;"> 
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;"><strong><br />
关于大宗物品说明<br />
</strong><br />
大宗物品通常包括但不局限于以下类别商品：</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　A. 音响 / HIFI；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　B. 厨房电器(烤箱 / 净水器 / 咖啡机等)；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　C. 其它家电(冰箱 / 洗衣机 / 烘干机 / 空调机 / 电视机 / 烤箱等)；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　D. 乐器；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　E. 电脑及辅助设备(台式电脑 / 手提电脑 / 打印机 / 传真机 / 一体机 / 液晶显示器等)；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　F. 床上用品(床单 / 罩 / 被套 / 枕头等)；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　G. 居家装饰 ( 家具等 ) ；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　H. 健身器材；</span> 
</p>
<p style="margin-left:0px;">
	<span style="font-size:14px;color:#000000;">　　I. 户外野营用品。<br />
<br />
国际货运是按商品的重量和体积进行计费的。<br />
因此，如果我们审核您的订单时发现有大宗商品，则该商品的运费有可能增加，具体变动我们的客服会与您联系，谢谢您的理解与合作。<br />
<br />
</span> 
</p>
</span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/189.html">Viatang账户充值方式</a></li><li><a href="/Help/detail/id/141.html">如何跟踪运单</a></li><li><a href="/Help/detail/id/135.html">如何退款</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
