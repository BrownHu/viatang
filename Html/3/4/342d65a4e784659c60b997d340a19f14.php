  ...
  <div style="width:988px; height:100%; overflow:hidden; margin:0px;" class="nobd">
    <div id="m1l" style="width:647px; min-height:486px; height:100%; overflow:hidden; padding-bottom:20px;" class="left bbrd">
      ...
      <div class="news_left middle" style="text-align:left; padding-bottom:6px;">
        <div align="center">
          <h2><span style="font-size:14px; font-family:Arial, Helvetica, sans-serif">如何付款？可以使用什么币种充值呢？</span></h2>
        </div>
        <div class="news_content1 middle">
          <span class="Apple-style-span" style="font-family:Arial, Helvetica, sans-serif;line-height:23px;font-size:14px;">
<ul style="margin-left:0px;">
	<p style="text-indent:0px;">
		<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们支持您使用各种币种支付。</span>
	</p>
	<p style="text-indent:0px;">
		<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在唯唐网，所有货币单位均为人民币。如果您使用国外银行卡或信用卡充值，充值平台会自动将您的币种按当前实际汇率转换成美元结算，悠乐网再将美元金额转换成人民币充值到您的账户。汇率均为实时。充值所产生汇率损失极小。</span>
	</p>
	<p style="text-indent:0px;">
		<strong><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;<span class="Apple-style-span" style="font-weight:normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目前支持以下几种在线充值方式：</span></span></strong>
	</p>
	<p style="text-indent:0px;">
		<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="font-size:12px;">&nbsp;paypal</span><span style="font-size:12px;">余额支付；国际信用卡、银行卡支付；国内信用卡、银行卡支付；支付宝账户支付；委托国内亲友转账；</span>
	</p>
	<p style="text-indent:0px;">
