...
<title>订单状态说明-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">订单状态说明</p>
...
<p style="margin-left:0px;">
	<span style="color:#333333;"><strong>订单状态</strong></span> 
</p>
<p style="margin-left:0px;">
	<strong>未处理：</strong>订单提交后的初始状态
</p>
<p style="margin-left:0px;">
	<strong>处理中：</strong>订单已分配到相应采购员处
</p>
<p style="margin-left:0px;">
	<strong>订购中：</strong>采购员正在向商家订购商品
</p>
<p style="margin-left:0px;">
	<strong>已订购：</strong>商品已订购，正在等待商品到达viatang
</p>
<p style="margin-left:0px;">
	<strong>无货<span style="color:#333333;">*</span>：</strong>商品断货
</p>
<p style="margin-left:0px;">
	<strong>无效订单<span style="color:#333333;">*</span>：</strong>会员已取消订单；会员提交了网页错误的商品网址；实际商品名称、价格与您提交的不一致；实际商品无图片或描述；虚拟商品、违禁商品等，均视为无效订单。
</p>
<p style="margin-left:0px;">
	<strong>问题订单：</strong>指缺少必须的尺码、颜色说明等，需等待客户进一步确认才能购买的订单
</p>
<p style="margin-left:0px;">
	<strong>退换货处理中：</strong>与卖家协商后做退换货处理
</p>
<p style="margin-left:0px;">
	<strong>联系卖家中：</strong>指与卖家联系，但未得到回复。如您不愿等待，可联系viatang进行退款
</p>
<p style="margin-left:0px;">
	<strong>已到货：</strong>订购商品已经到达
</p>
<p style="margin-left:0px;">
	<br />
</p>
<p style="margin-left:0px;">
	<span style="color:#333333;"><strong>包裹状态</strong></span> 
</p>
<p style="margin-left:0px;">
	<strong>未处理：</strong>运单提交后的初始状态
</p>
<p style="margin-left:0px;">
	<strong>处理中：</strong>仓库正在处理运单，出库和打包
</p>
<p style="margin-left:0px;">
	<strong>配送中：</strong>已完成出库包装工作，仓库正在发货
</p>
<p style="margin-left:0px;">
	<strong>已发货：</strong>包裹已发送给运输方
</p>
<p style="margin-left:0px;">
	<strong>信息有误<span style="color:#333333;">*</span>：</strong>收件人姓名、地址等信息错误或者不详细；或<span class="Apple-style-span" style="font-family:Verdana, Arial, Helvetica, sans-serif;line-height:24px;font-size:14px;color:#666666;">商品中含有所选择的运输方式禁运的物品</span>
</p>
<p style="margin-left:0px;">
	<strong>确认收货：</strong>您已收到包裹
</p>
<p style="margin-left:0px;">
	<br />
</p>
<p style="margin-left:0px;">
	<span style="color:#808080;">（温馨提示：凡带<strong><span style="color:#333333;">*</span></strong>号的订/运单，您只需自行删除，费用将自动退回您的viatang账户中。</span>）
</p>
</span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/137.html">代购费用是如何计算的呢？</a></li><li><a href="/Help/detail/id/127.html">代购流程</a></li><li><a href="/Help/detail/id/125.html">去哪里挑选代购商品</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
