...
<title>为什么我只充值一次，却显示我充了一模一样的两次？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">为什么我只充值一次，却显示我充了一模一样的两次？</p>
...
<span style="font-size:14px;">这可能是由于当时网络反应较慢，您点击了两次按钮导致。</span><span style="font-size:14px;"><br />
<br />
您不用担心，您可以要求我们将重复项退回，或者保留至下次购物继续使用。<br />
<br />
<br />
</span><br />
</span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/75.html">充值到账时间及手续费</a></li><li><a href="/Help/detail/id/80.html">退款后账户里怎么会是负数？</a></li><li><a href="/Help/detail/id/79.html">使用国内网银在线充值，银行已经扣款了，账户余额却没有增加，怎么办呢？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
