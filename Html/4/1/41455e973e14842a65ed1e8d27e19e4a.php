...
<title>唯唐代购省钱攻略-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">唯唐代购省钱攻略</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <p>
	<span style="font-size:14px;">1、购物一站式解决，免除您购物诸多繁琐程序，为您节省大量时间和金钱。</span> 
</p>
<p>
	<span style="font-size:14px;">2、我们保证商品代购的正确性，您将不必再为卖家发货错误而担心，安全而便利的购物过程将有效为您节约成本。</span> 
</p>
<p>
	<span style="font-size:14px;">3、您可以在不同的网站任意订购商品，选择整体包装邮寄，有效地为您节省国际运费。</span> 
</p>
<p>
	<span style="font-size:14px;">4、通过Viatang代购的商品，如果在保修期内出现质量问题，我们可以帮助您退换货，此项服务完全免费，您只需承担商品的来回运费。</span> 
</p>
<p>
	<span style="font-size:14px;">5、我的送货车，您可以根据商品重量自行安排调配，一切随心所欲。此外，我们为您提供多种运输方式，您可以根据需要自行选择。</span> 
</p>
<p>
	<span style="font-size:14px;">6、如果您要求代购的商品暂时不能寄出，我们可以为您免费保管6个月。</span> 
</p>
<p>
	<span style="font-size:14px;">7、如果您的包裹丢失，我们将为您赔偿(最高￥1000元)，消除您的后顾之忧.(邮局的包裹丢失率为0.5%)。</span> 
</p>
<p>
	<span style="font-size:14px;">8、多样化的付款方式，让您轻松随意完成账户充值。随意充值，随时提款。</span> 
</p>
<p>
	<span style="font-size:14px;">9、提供多样化运输方式(不到2000g商品可按AIR小包计算方式，运费超低)，最大程度的节省您的运费。<br />
<br />
</span> 
</p>
<table class="ke-zeroborder" width="100%" bgcolor="#f7f7f7" border="0" cellpadding="5" cellspacing="1">
	<tbody>
		<tr class="redtext">
			<td>
				<span style="font-size:14px;">运单商品</span> 
			</td>
			<td>
				<span style="font-size:14px;">国内人民币售价</span> 
			</td>
			<td>
				<span style="font-size:14px;">商品重量</span> 
			</td>
			<td>
				<span style="font-size:14px;">欧洲售价</span> 
			</td>
		</tr>
		<tr>
			<td>
				<span style="font-size:14px;">瑞丽服饰2件</span> 
			</td>
			<td>
				<span style="font-size:14px;">售价140RMB</span> 
			</td>
			<td>
				<span style="font-size:14px;">重量400g</span> 
			</td>
			<td>
				<span style="font-size:14px;">65欧</span> 
			</td>
		</tr>
		<tr>
			<td>
				<span style="font-size:14px;">杂志（贝太厨房一本）</span> 
			</td>
			<td>
				<span style="font-size:14px;">售价14 RMB</span> 
			</td>
			<td>
				<span style="font-size:14px;">重量200g</span> 
			</td>
			<td>
				<span style="font-size:14px;">6 欧</span> 
			</td>
		</tr>
		<tr>
			<td>
				<span style="font-size:14px;">德汉电子词典（yida外交家一台）</span> 
			</td>
			<td>
				<span style="font-size:14px;">售价340RMB</span> 
			</td>
			<td>
				<span style="font-size:14px;">重量300g</span> 
			</td>
			<td>
				<span style="font-size:14px;">55欧</span> 
			</td>
		</tr>
		<tr>
			<td>
				<span style="font-size:14px;">3件商品合计：</span> 
			</td>
			<td>
				<span style="font-size:14px;">494RMB</span> 
			</td>
			<td>
				<span style="font-size:14px;">900g+90g(10%箱重）＝990g</span> 
			</td>
			<td class="bluetext">
				<span style="font-size:14px;">126欧</span> 
			</td>
		</tr>
		<tr>
			<td colspan="4">
				<span style="font-size:14px;">实际购买价格＝494*1.1+161(邮局air方式）＝704.4－－》/9.8(欧元兑换率)= </span><span style="font-size:14px;" class="bluetext">71.9欧</span><span style="font-size:14px;">（您节省了47欧）</span> 
			</td>
		</tr>
	</tbody>
</table>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/121.html">代购周期</a></li><li><a href="/Help/detail/id/191.html">不能登录viatang 系统的常见问题</a></li><li><a href="/Help/detail/id/173.html">身在海外，怎样购买中国商品？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
