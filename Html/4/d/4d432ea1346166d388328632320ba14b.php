...
<title>怎么跟踪AIR,EMS包裹号码-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">怎么跟踪AIR,EMS包裹号码</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <span class="Apple-style-span" style="font-family:Arial,Helvetica,sans-serif;line-height:23px;"><span style="font-size:14px;">&nbsp;</span><br />
<span><span style="font-size:14px;">根据唯唐代购首页提供的“包裹跟踪”链接进入邮局查询网站，输入包裹号查询，或直接登陆中国邮政/各国邮局网站进行跟踪查询</span><span style="font-size:14px;">http://www.ems.com.cn/</span><span style="font-size:14px;">; </span><span style="font-size:14px;">http://intmail.183.com.cn/</span><span style="font-size:14px;"><br />
<br />
基于客户服务完善，每位用户都有客服专员为您跟进，并通过邮件的方式联系您包裹情况，您可以放心。<br />
<br />
<br />
<br />
</span></span></span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/48.html">我的包裹怎么还没到？不是承诺说EMS一周左右可以到的吗？</a></li><li><a href="/Help/detail/id/56.html">都超过你们所说的运送周期还没收到包裹，会丢吗？丢了会赔吗？</a></li><li><a href="/Help/detail/id/51.html">包裹退包是什么意思？为什么会被退？什么时候重发？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
