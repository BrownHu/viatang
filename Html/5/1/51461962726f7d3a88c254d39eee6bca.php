...
<title>哪些原因容易导致充值不成功？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">哪些原因容易导致充值不成功？</p>
...
<span style="color:#333333;"> 1、采用Paypal、国外信用卡或中国大陆银行卡充值的用户充值不成功，可能有以下原因：</span></span></strong><span style="font-size:14px;"><br />
<span style="color:#333333;"> （1）如果充值时填写的用户名，与您在</span><span style="font-size:14px;color:#333333;">Viatang</span><span style="color:#333333;">注册的用户名不一致，第三方审查时会出现错误，将无法进行自动充值。</span><br />
<span style="color:#333333;"> （2）如果您在一个相对较短的时间段频繁充值，有可能导致系统只抓取到其中一项充值信息。</span><br />
<span style="color:#333333;"> （3）如果充值时您填写的信息有误，也可能导致银行扣款不成功。</span><br />
<span style="color:#333333;"> （4）有时候可能是浏览器问题导致充值不成功。您可以先清除浏览器的Cookies，然后再重新充值，如果还是不行，再换另一个浏览器重新登录充值。</span></span> 
	</p>
	<p style="margin-left:0px;">
		<strong><span style="font-size:14px;"><br />
<span style="color:#333333;"> 2、采用中国大陆汇款、海外电汇或西联汇款的用户充值不成功，可能有以下原因：</span></span></strong><span style="font-size:14px;"><br />
<span style="color:#333333;"> (1) 您汇款后，如果没有把汇款的相关信息（例如汇款日期、汇款金额、汇款人姓名等相关信息）在</span></span><span style="font-size:14px;color:#333333;">线下充值页面</span><span style="font-size:14px;"><span style="color:#333333;">提交，</span><span style="font-size:14px;color:#333333;"><span style="font-size:14px;color:#333333;">Viatang</span></span><span style="color:#333333;">将无法进行核实并为您手动充值。</span></span><span style="font-size:14px;"><br />
<span style="color:#333333;"> (2) 您汇款后，如果汇款的相关信息填写有误，唯唐代购将无法为您进行核实。</span></span><span style="font-size:14px;"><br />
        ...
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/79.html">使用国内网银在线充值，银行已经扣款了，账户余额却没有增加，怎么办呢？</a></li><li><a href="/Help/detail/id/80.html">退款后账户里怎么会是负数？</a></li><li><a href="/Help/detail/id/149.html">代购的相关费用</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
