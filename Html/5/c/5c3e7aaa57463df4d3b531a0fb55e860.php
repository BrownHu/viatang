  ...
  <div style="width:988px; height:100%; overflow:hidden; margin:0px;" class="nobd">
    <div id="m1l" style="width:647px; min-height:486px; height:100%; overflow:hidden; padding-bottom:20px;" class="left bbrd">
      ...
      <div class="news_left middle" style="text-align:left; padding-bottom:6px;">
        <div align="center">
          <h2><span style="font-size:14px; font-family:Arial, Helvetica, sans-serif">我需要退换货，流程是怎样的？</span></h2>
        </div>
        <div class="news_content1 middle">
          <span class="Apple-style-span" style="font-family:Arial,Helvetica,sans-serif;line-height:23px;"></span><strong><span style="font-size:14px;"><br />
第一步：</span></strong><span style="font-size:14px;">如果您在收到货物后发现商品无法使用，或与您的订购要求不符，请您将商品详情（如商品编号，名称，照片等）发送邮件至</span><span><a href="mailto:service@ulowi.com" target="_blank"><span style="font-size:14px;">service@viatang.com</span></a></span> <strong><span style="font-size:14px;"><br />
<br />
第二步：</span></strong><span style="font-size:14px;">工作人员收到您的信息后，将立即开始处理您的问题。<br />
若是由于验货或包装产生问题，我们将会给与您全额退款并承担商品寄回运费；<br />
如商品涉及保修或其它销售商承担售后服务，我们会与其沟通。<br />
当确定他们接受退换时，我们将通过电子邮件与您联系，告知您退换的细节。</span><strong><span style="font-size:14px;"><br />
<br />
第三步：</span></strong><span style="font-size:14px;">在您收到退换信息后，请您将相关物品（商品+原始购买凭证+商品原包装+唯唐代购发给您的退货审核结果邮件打印件）寄还给我们，我们将在收到您的货物后寄送给销售商，并退回您的款项。<br />
需要注意的是，商品应在销售商承诺退货的期限内寄回，否则，对方可能会不予退还或提出其它附加条件。</span> <span style="font-size:14px;"></span><span class="Apple-style-span" style="font-family:Arial,Helvetica,sans-serif;line-height:23px;"></span>        </div>
      </div>
    </div>
