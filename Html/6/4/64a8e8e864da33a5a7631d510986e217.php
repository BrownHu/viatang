...
<title>假如我要退款，该如何操作？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">假如我要退款，该如何操作？</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <span class="Apple-style-span" style="font-family:Verdana, Arial, Helvetica, sans-serif;line-height:24px;font-size:14px;color:#666666;"><span style="color:#666666;"><span style="color:#333333;"><br />
如果您已经和我们有了多次合作，就会发现，我们提供的是一种如同朋友般亲切与值得信赖的服务。</span><br />
<span style="color:#333333;"> 许多用户为了节省订购过程中的麻烦或是希望缩短流程耽误的时间，会采取预先将一笔费用存在账户中；您也可以根据自己的需要尝试使用这种方法。</span><br />
<span style="color:#333333;"> 不过当您觉得短期内不需要再从中国订购商品，或是您付款后由于某些原因商品采购没能实现的时候，您可以随时申请将余款退回。</span><br />
<br />
<span style="color:#333333;"> 您通过注册邮箱，发送邮件至service@viatang.com，说明您的退款需求即可</span></span><span style="color:#333333;">，财务人员会在5-7个工作日为您处理完成。<br />
<br />
<br />
</span></span>        </div>
