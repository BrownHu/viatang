...
<title>怎么分开打包？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">怎么分开打包？</p>
...
<span style="font-size:14px;">所有商品到货后，均会更新状态为“已入库”；每件商品，都会有勾选处，您将需要邮寄的商品勾选，并提交打包便可；</span><br />
<br />
<span style="font-size:14px;">如果您需要将商品分开打包，您可以分次提交打包；</span><br />
<br />
<span style="font-size:14px;">同时，我们为您的商品提供180天免费保存时间，以满足您不同时期打包需求。<br />
<br />
<br />
<br />
</span><br />
        ...
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/53.html">我已提交打包，包裹什么时候发出？</a></li><li><a href="/Help/detail/id/215.html">你们的国际运费是全部运费总价了吗？还需要付燃油附加费吗？</a></li><li><a href="/Help/detail/id/46.html">如何修改运送方式？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
