...
<title>商品的保管期限-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">商品的保管期限</p>
...
<span style="font-size:14px;"> 为便于用户不同的打包需求，唯唐代购为您的商品免费保管长达</span></span><span style="font-size:14px;">180</span><span style="font-size:14px;font-family:宋体;">天（约</span><span style="font-size:14px;">6</span><span style="font-size:14px;font-family:宋体;">个月）</span><span style="font-size:10.5pt;font-family:;"><br />
<br />
<br />
<br />
</span><strong><span style="font-size:14px;font-family:宋体;">具体细则：</span></strong><span style="font-size:10.5pt;font-family:;"><br />
<br />
</span><span style="font-size:14px;font-family:宋体;">保管期限自商品状态显示为</span><span style="font-size:14px;">“</span><span style="font-size:14px;font-family:宋体;">已入库</span><span style="font-size:14px;">”</span><span style="font-size:14px;font-family:宋体;">日开始计算。在保管期内由</span><span style="font-size:14px;">Viatang</span><span style="font-size:14px;font-family:宋体;">负责对商品进行保管并承担相应责任，但用户购买的商品保质期在保管期内的例外（例如：易变质物品保质期只有</span><span style="font-size:14px;">1</span><span style="font-size:14px;font-family:宋体;">个月）。</span><span style="font-size:12.0pt;font-family:;"><br />
</span><span style="font-size:14px;font-family:宋体;">保管期超过</span><span style="font-size:14px;">150</span><span style="font-size:14px;font-family:宋体;">天会发送站内信温馨提示提交包裹运单，超</span><span style="font-size:14px;">180</span><span style="font-size:14px;font-family:宋体;">天任未提交包裹运单或做任何反馈将视放弃商品，我们将统一对过期的商品做销毁处理。</span><span style="font-size:10.5pt;font-family:;"><br />
<br />
<br />
<br />
</span><span style="font-size:12.0pt;font-family:宋体;"><span style="font-size:14px;">温馨提示：销毁的商品不再做任何提示和告知，为避免商品销毁，请您一定在保管有效期内提交包裹运单，感谢您的配合与理解！</span><br />
<br />
<br />
</span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/135.html">如何退款</a></li><li><a href="/Help/detail/id/131.html">订单状态说明</a></li><li><a href="/Help/detail/id/129.html">如何生成订单</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
