...
<title>我的包裹怎么还没到？不是承诺说EMS一周左右可以到的吗？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">我的包裹怎么还没到？不是承诺说EMS一周左右可以到的吗？</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <span class="Apple-style-span" style="font-family:Arial, Helvetica, sans-serif;line-height:23px;font-size:12px;"><strong><span style="font-size:14px;"><br />
关于包裹实际配送时间说明</span></strong><br />
<br />
<span style="font-size:14px;">由于不同地区海关及邮政处理效率，以及假期，天气等客观因素，会导致包裹的实际配送时间延缓；</span><br />
<br />
<span style="font-size:14px;">如唯唐代购发现您的包裹异常，也会及时联系邮局查询，并与您联系；</span><br />
<br />
<span style="font-size:14px;">您也可以将包裹单号告知与我们，同样为您查询并跟进。</span></span>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/38.html">怎么跟踪AIR,EMS包裹号码</a></li><li><a href="/Help/detail/id/51.html">包裹退包是什么意思？为什么会被退？什么时候重发？</a></li><li><a href="/Help/detail/id/56.html">都超过你们所说的运送周期还没收到包裹，会丢吗？丢了会赔吗？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
