...
<title>为什么5天了，商品还没有到货？-viatang.com</title>
...
<div id="m4" style="width:988px; height:100%; overflow:hidden; margin-top:14px;" class="middle nobd">
  ...
  <div id="faq" style="width:798px; height:100%; overflow:hidden;" class="right brd">
    ...
    <div style="width:760px; height:100%; overflow:hidden; padding-bottom:20px;" class="nobd middle">
		<p style="display:inline-block; height:30px; line-height:30px; overflow:hidden; border-bottom:1px dashed #999; width:100%;" class="middle">为什么5天了，商品还没有到货？</p>
        <div style="margin-top:10px; line-height:20px; text-align:left; text-indent:20px; padding-bottom:20px; border-bottom:1px dashed #999;">
          <p class="MsoNormal">
	<span class="apple-style-span"><span style="font-family:&quot;"><br />
</span></span><span style="font-size:14px;" class="apple-style-span"><span style="font-family:宋体;font-size:14px;">商品的到货速度取决于卖家的发货时间和所选快递的发货速度。</span></span><span class="apple-style-span"><span style="font-family:&quot;"><br />
<br />
</span></span><span style="font-size:14px;" class="apple-style-span"><span style="font-family:宋体;font-size:14px;">有部分商品由于销售情况好而断货，卖家需几个工作日补货；</span></span><span class="apple-style-span"><span style="font-family:&quot;"><br />
<br />
</span></span><span style="font-size:14px;" class="apple-style-span"><span style="font-family:宋体;font-size:14px;">如果您希望缩短商品到货时间，建议可选择“江浙沪”卖家，通常</span></span><span style="font-size:14px;" class="apple-style-span"><span style="font-family:&quot;font-size:14px;">1-2</span></span><span style="font-size:14px;" class="apple-style-span"><span style="font-family:宋体;font-size:14px;">个工作日便可收到。</span></span><span></span>
</p>        </div>
        <div style="margin-top:10px; text-align:left;" class="nobd">
            ...
            <div id="csr_faq" style="width:100%; height:100%; overflow:hidden;" class="nobd">
            	<ul>
                <li><a href="/Help/detail/id/32.html">代购流程 只需5步，轻松代购中国商品</a></li><li><a href="/Help/detail/id/42.html">无效订单是什么意思？</a></li><li><a href="/Help/detail/id/72.html">代购订单已经支付完毕，为什么还需要补款？</a></li>                                </ul>
            </div>
        </div>
    </div>
  </div>
