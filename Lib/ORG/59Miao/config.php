...
define ( 'APPKEY', '1003586' ); //设置59秒appkey
define ( 'APPKEY', '1003586' ); //设置59秒appkey
define ( 'APPSECRET', '588c7f57e60f1e70ac44dfa09b9c19ba' ); //设置59秒appSecret
define ( 'APIURL', 'http://gw.api.59miao.com/Router/Rest?' ); //设置与59秒通信的地址
define ( 'APICACHE_TIME', '3600' ); //1小时   设置缓存时间，单位为秒
define ( 'API_CACHEPATH', 'Apicache' ); //设置api缓存目录
define ( 'API_CACHETIME', '0' ); //设置api缓存时间   单位为秒   0表示不缓存
//是否自动清除缓存
//自动清除过期缓存的时间间隔，
//格式是：* * * *
