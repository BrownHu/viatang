...
class paypal_service{
	...
	var $item_name;	//显示名称
	var $amount;		//付款金额 
	var $custom; 		//回传参数，这里用来保存，要次充值产生的流水号(viatang方) 
	...
	*/
	function build_form() {
		...
		$sHtml .= "<input type='hidden' name='charset' value='utf-8' />";
		...
		$sHtml .= "<input type='hidden' name='cpp_cart_border_color' value='#ccc'/>";
