	...
	public function check_error($paramArr) {
		...
		switch ($method) {
			case 'taobao.users.get' :
				if ($paramArr ['nicks'] == '') {
					$re = 'Missing required arguments:nicks';
				}
				break;
			case 'taobao.taobaoke.items.convert' :
				if ($paramArr ['num_iids'] == '') {
					$re = 'Missing required arguments:num_iids';
				}
				break;
			...
			case 'taobao.taobaoke.shops.convert' :
				if ($paramArr ['sids'] == '') {
					$re = 'Missing required arguments:sids';
				}
				break;
			case 'taobao.taobaoke.items.get' :
				if ($paramArr ['cid'] == '' && $paramArr ['keyword'] == '') {
