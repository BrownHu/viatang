 ...
 * 
 * 版本历史
 * 1，修正php 针对json_encode 布尔型的bug
 * 2, 增加上传媒体资源的接口
 * 3， 增加群发接口
 * 4, 清理不用的代码
 * 5, 增加调试接口 
 * 6, 增加更新 access_token 接口
 +------------------------------------------------------------------------------
 * @category   daigoucms
 * @author     soitun <stone@zline.net.cn>
 * @copyright  上海子凌网络科技有限公司
 * @license    http://www.daigoucms.cn/license-agreement.html
 * @link       http://www.daigoucms.cn/
 +------------------------------------------------------------------------------
 */
namespace Com;
