...
class Weixinpay {
    ...
    public function __construct(){
        ...
        $this->config['APPID']=C('WEPAY_APPID');
        $this->config['MCHID']=C('WEPAY_MCHID');
        $this->config['KEY']=C('WEPAY_KEY');
        $this->config['APPSECRET']=C('WEPAY_APPSECRET');
        $this->config['NOTIFY_URL']=C('WEPAY_NOTIFY_URL');
    }
    ...
    **/
    ...
    public function getParameters(){
            ...
            $config=$this->config;
            // 取出订单号
//            $out_trade_no=I('get.out_trade_no',0,'intval');
