...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid($_SESSION['WEPAY_APPID']);//公众账号ID
		$inputObj->SetMch_id($_SESSION['WEPAY_MCHID']);//商户号
	...
	{
		//如果不需要上报数据
		if($_SESSION['WEPAY_REPORT_LEVENL'] == 0){
			return;
		} 
		//如果仅失败上报
		if($_SESSION['WEPAY_REPORT_LEVENL'] == 1 &&
	...
	/* 	if(WxPayConfig::CURL_PROXY_HOST != "0.0.0.0" 
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, $_SESSION['WEPAY_SSLCERT_PATH']);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, $_SESSION['WEPAY_SSLKEY_PATH']);
		}
		//post提交方式
