...
function slider() {
	if( gcount == 1){
		...
		$('#bn00').removeClass().addClass('bn00-4').addClass('nobd');
    	$('#bn01').removeClass().addClass('bn01-4').addClass('middle').addClass('nobd');
		...
		$('#slider_img_pos li').removeClass("gli_on").addClass('gli_no').addClass('left');
		$('#bt_04').removeClass().addClass('gli_on').addClass('left');
		 gcount = 1;
	}
}
